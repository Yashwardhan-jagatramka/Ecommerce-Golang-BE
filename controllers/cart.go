...
func (app *Application) AddToCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = database.AddProductToCart(ctx, app.prodCollection, app.userCollection, productID, userOueryID)
		if err != nil {
...
func (app *Application) RemoveItem() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = database.RemoveCartItem(ctx, app.prodCollection, app.userCollection, productID, userOueryID)
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, err)
			return
		}
...
func (app *Application) GetItemFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		user_id, _ := primitive.ObjectIDFromHex(user)
...
func (app *Application) InstantBuy() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err = database.InstantBuyer(ctx, app.prodCollection, app.userCollection, productID, userOueryID)
		if err != nil {
			c.IndentedJSON(http.StatusInternalServerError, err)
			return
		}
